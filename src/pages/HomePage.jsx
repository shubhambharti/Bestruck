...
export default function HomePage() {
    return (
        <>
            <div className="w-100 overflow-hidden theme-color" id="top">
                <Seo
                    title="Home"
                    description={`Welcome to ${import.meta.env.VITE_SITE_NAME || " MF Engineering And Fabrication"}'s. Discover our expert engineering, fabrication, and industrial solutions.`}
                />
                <div className="container position-relative">
                    ...
                    <div className="row">
                        <div className="col-lg-7 py-vh-6 position-relative" data-aos="fade-right">
                            ...
                            <Link to="/aboutus" className="btn btn-theme-dark-color btn-xl shadow me-3 rounded-5 fw-bold my-5">Who We Are?</Link>
                        </div>
                    </div>
                </div>
            </div>
